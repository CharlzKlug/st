...
//                               QString::number(green)+","+QString::number(blue)+");");
    ...
    signalMapper->setMapping(buttonRed, 1);
    signalMapper->setMapping(buttonGreen, 2);
    signalMapper->setMapping(buttonBlue, 4);
    signalMapper->setMapping(buttonBlack, 8);
    signalMapper->setMapping(buttonWhite, 16);
    signalMapper->setMapping(buttonYellow, 32);
    signalMapper->setMapping(buttonSkyBlue, 64);
    signalMapper->setMapping(buttonPurple, 128);
    signalMapper->setMapping(buttonOrange, 256);
