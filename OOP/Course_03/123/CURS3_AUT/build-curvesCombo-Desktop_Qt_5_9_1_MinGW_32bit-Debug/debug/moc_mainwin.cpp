...
QT_MOC_LITERAL(1, 8, 12), // "slotComboExp"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 1), // "k"
QT_MOC_LITERAL(4, 24, 10) // "slotSlider"

    },
    "MainWin\0slotComboExp\0\0k\0slotSlider"
};
...
void MainWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotComboExp((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->slotSlider((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *MainWin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "MyPainter"))
        return static_cast< MyPainter*>(const_cast< MainWin*>(this));
