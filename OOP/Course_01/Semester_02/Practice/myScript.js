var numLetters = [], firstMul, secondMul;
...
function fillTable() {
    ...
    for (i = 1; i <= k; ++i) {
	document.getElementById('letter3'+i).innerHTML = numLetters[temp % 10];
    ...
    for (i = 1; i <= k; ++i) {
	document.getElementById('letter4'+i).innerHTML = numLetters[temp % 10];
	temp = Math.floor(temp / 10);
    }
